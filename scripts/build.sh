#!/usr/bin/env bash
# Builds Invoque.app from the command line and reveals it in Finder on success.
# Incremental Release build by default; --clean resets the wedged Swift Build
# service (the CreateBuildDescription / clang-probe hang) and wipes build/
# before building. Thin stub for the shared lkm-build engine.
#
...
export BUILD_XCODE_SCHEME="Invoque"
